...
lecture_list = [
  ...
  ['HTML Structure','HTML is organized as a collection of family tree relationships. When an element is contained inside another element,it is considered the child of that element. The child element is said to be nested inside of the parent element.',"https://res.cloudinary.com/dxx1c1rby/image/upload/v1566374582/Screenshot_2019-08-21_at_15.38.12_k7k89v.png",1, Level.second.id],
  ['Heading Elements in HTML', 'Headings in HTML are similar to headings in other types of media. For example, in newspapers, large headings are typically used to capture a reader’s attention. Other times, headings are used to describe content, like the title of a movie or an educational article.',  "https://res.cloudinary.com/dxx1c1rby/image/upload/v1566374582/Screenshot_2019-08-21_at_15.38.54_c2jpwl.png", 2, Level.second.id],
  ['The Body', 'One of the key HTML elements we use to build a webpage is the body element. Only content inside the opening and closing body tags can be displayed to the screen.',  'https://res.cloudinary.com/dxx1c1rby/image/upload/v1566374582/Screenshot_2019-08-21_at_15.39.14_cqicec.png', 3, Level.second.id],
