...
lecture_list = [
  ...
  ['The Body', 'One of the key HTML elements we use to build a webpage is the body element. Only content inside the opening and closing body tags can be displayed to the screen.',  'https://res.cloudinary.com/dxx1c1rby/image/upload/v1566374582/Screenshot_2019-08-21_at_15.39.14_cqicec.pnghttps://res.cloudinary.com/dxx1c1rby/image/upload/v1566374582/Screenshot_2019-08-21_at_15.39.14_cqicec.png', 3, Level.first.id],
